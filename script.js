document.addEventListener('DOMContentLoaded', () => {
    ...
    // IMPORTANT: This tells GitHub Pages where to find your live Vercel Backend!
    ...
    if (feedbackForm) {
        feedbackForm.addEventListener('submit', async (e) => {
            ...
            try {
                const res = await fetch(`${API_BASE_URL}/api/submit-feedback`, {
    ...
    if (bookingForm) {
        ...
        if(!isLoggedIn) {
            ...
            bookingForm.addEventListener('submit', async function(e) {
                ...
                try {
                    const res = await fetch(`${API_BASE_URL}/api/submit-booking`, {
                        method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data)
                    });
                    const result = await res.json();
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', async function(e) {
            ...
            try {
                const res = await fetch(`${API_BASE_URL}/api/submit-contact`, {
                    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data)
                });
    ...
    if (affiliateForm) {
        affiliateForm.addEventListener('submit', async function(e) {
            ...
            try {
                const res = await fetch(`${API_BASE_URL}/api/submit-affiliate`, {
                    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data)
                });
